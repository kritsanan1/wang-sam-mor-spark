...
const FoodSection = () => {
  ...
  return <section id="food" className="section-spacing">
      <div className="wang-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {foods.map((item, index) => <div key={index} className="feature-card flex flex-col items-center text-center hover-scale">
              <div className="mb-4">
                {item.icon}
              </div>
              ...
              <img src={`https://source.unsplash.com/random/300x200/?thai,food,${index + 1}`} alt={item.title} loading="lazy" className="w-full h-48 object-cover rounded-lg mt-4" />
            </div>)}
        </div>
